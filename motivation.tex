...
other entities and attributes as noise, we can successfully align the \emph{Xinjiang} entity. \FIXME{ZW: I don't think this makes sense.
Because one can simply use Urumqi to align the entity? Unless you give an counter example entity that is not Xinjiang but also links to
Urumqi}. 
\FIXME{WYT: I don't think we can simply use Urumqi to align the entity, because maybe a county in Urumqi or someone born in Urumqi will also link to Urumqi. But with the help of the value, we can be more sure that the entity is Xinjiang.}
