...
%	
	For for each entity within the TWO target \KGs, We construct A normalized attribute vector. The dimension of the vector equals to the number of distinct attributes of the target attribute types.
