...
graph $G$. We utilize pre-aligned entity pairs to train our models and then discover latent aligned entities. Figure~\ref{all} demonstrates
the overall architecture of our model. 	
 ...
 Our work improves \RGCNs in two ways. Firstly, we introduce highway gates to reduce the impact of noise.
    Secondly, we use automatically learned semantic features such as entity names and attributes to help the \RGCN better capture the
