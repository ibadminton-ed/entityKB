...
\cparagraph{Model architecture} Figure~\ref{fig:all} depicts the overall architecture of our \RGCN-based \KG representation model. 	
  ...
  names and their attributes, and (ii) a list of adjacency matrices, which describes the adjacency relationships among nodes of a \KG.
    The output of a \RGCN layer is processed by a highway gate function (Section~\ref{section:hgcn}), and the processed result is passed as part of
   ...
   network output (Section~\ref{prediction}).
	...
	\subsection{Modeling Knowledge Graph Information}
	\label{section:rgcn}	
...
We use two sets of information to represent nodes and relations of neighboring nodes of a \KG, described as follow.
