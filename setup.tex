...
%	These hyperparameters were found to give the best overall performance in our experiments.
    ...
    against two approaches: JE and ITransE~\cite{zhu2017iterative}. We note that MTransE is tuned for cross-lingual knowledge alignment, while JAPE cannot be applied to the WBD dataset because
    it
