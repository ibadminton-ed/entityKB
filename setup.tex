...
39.2 million structured triples.
	...
	Table~\ref{dataset} gives the statistics of this dataset. \FIXME{Check the texts against the table.}
...
\end{table}
	...
	These hyperparameters were found to give the best overall performance in our experiments. \FIXME{ZW: Check the description of
    \HGCN.}



    \cparagraph{Prior methods}
    On the $DBP15K_{FR-EN}$ dataset, we compare our \HRGCN model against three state-of-the-art methods that have been tuned and tested on
