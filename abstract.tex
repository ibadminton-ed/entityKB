	...
	which is typically performed on the \KGs by using graph embedding methods to represent the entities and their context. However,
existing approaches often fail to identify the sparse but discriminative evidence from heterogenous \KGs that usually have different
structures and properties. As a result, exiting entity alignment methods  have to either rely on heavily annotated training data which
