	...
	which is typically performed on the \KGs by using graph embedding methods to represent the entities
...
usually have different structures and properties. As a result, exiting entity alignment methods either have to rely on strong annotated training data
...
and attribute information. Further, we show that by introducing layer-wise highway network gates to the model, our approach can
