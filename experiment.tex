...
\cparagraph{\GCNs vs. prior methods} Both the \GCN and JE only relies on aligned entities but not aligned relations or triples.  On WBD
...
\cparagraph{\GCN vs. \RGCN} As shown in both Table~\ref{f1} and Table~\ref{cross}, comparing with \GCN, \RGCN further boosts the
